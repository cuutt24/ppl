                    ...
                    <div class="card shadow-sm bg-light bg-gradient mb-3">
                        <div class="card-body">
                            <div class="d-flex">
                                ...
                                <a href="/dashboard/pengguna/create" class="btn btn-warning fw-semibold ms-auto"
                                    type="button" data-bss-hover-animate="tada">Tambah Pengguna
                                    <?xml version="1.0" ?>
                                            ...
                                            @foreach ($users as $key => $user)
                                                <tr>
                                                    ...
                                                    <td>
                                                        ...
                                                        <form action="/dashboard/pengguna/{{ $user->id }}"
