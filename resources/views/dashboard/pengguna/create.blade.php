            ...
            <div class="card text-bg-light mb-3">
                <div class="card-body">
                    <a href="/dashboard">
                        ...
                        </svg></a> / <a href="/dashboard/pengguna">Manajemen Pengguna</a> / Tambah Data
                </div>
            </div>
            <div class="row">
                <div class="col-md-12 col-sm-12">
                    ...
                    <div class="card shadow-sm bg-light bg-gradient mb-3">
                        <div class="card-body">
                            ...
                            <hr>
                            <form class="row g-2 responsive-small fw-semibold" method="post" action="/dashboard/pengguna">
                                @csrf
                                ...
                                <div class="col-md-6 position-relative">
                                    <label for="validationCustom01" class="form-label">E-Mail<span
                                            class="text-danger">*</span></label>
                                    <input type="text" id="validationCustom01" class="form-control responsive-small"
                                        name="email" placeholder="Isi E-Mail" required>
                                </div>
                                <div class="col-md-6 position-relative">
