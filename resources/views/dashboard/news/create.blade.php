            ...
            <div class="card text-bg-light mb-3">
                <div class="card-body">
                    <a href="/dashboard">
                        ...
                        </svg></a> / <a href="/dashboard/news">Manajemen Berita</a> / Tambah Data
                </div>
            </div>
            <div class="row">
                <div class="col-md-12 col-sm-12">
                    ...
                    <div class="card shadow-sm bg-light bg-gradient mb-3">
                        <div class="card-body">
                            ...
                            <hr>
                            <form class="row g-2 responsive-small fw-semibold" method="post" action="/dashboard/news"
                                ...
                                <div class="row mb-3">
                                    <div class="col-md-5 position-relative">
                                        ...
                                        <input type="text" id="validationCustom01" class="form-control responsive-small"
                                            name="judul" placeholder="Isi Judul Berita" required>
                                    </div>
                                    <div class="col-md-4 position-relative">
                                        <label for="validationCustom01" class="form-label">Penulis Berita<span
                                                class="text-danger">*</span></label>
                                        <input type="text" id="validationCustom01" class="form-control responsive-small"
                                            name="creator" value="{{ Auth::user()->name }}" placeholder="Isi Penulis Berita"
                                            readonly>
                                    </div>
                                    <div class="col-md-3">
                                ...
                                <div class="row mb-3">
                                    <div class="col-md-9 position-relative">
                                        ...
                                        <input type="file" id="validationCustom01" class="form-control responsive-small"
                                            ...
                                            onchange="showPreview(event);" id="file-ip-1" required>
                                    </div>
                                ...
                                <div class="row mb-3">
                                    <div class="col-12">
                                        <label for="validationCustom01" class="form-label ">Isi Berita<span
                                                class="text-danger">*</span></label>
                                        <textarea class="ckeditor form-control" name="berita" required></textarea>
                                    </div>
                                </div>
                                <p>
