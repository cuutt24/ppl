                    ...
                    <div class="card shadow-sm bg-light bg-gradient mb-3">
                        <div class="card-body">
                            <div class="d-flex">
                                ...
                                <a href="/dashboard/news/create" class="btn btn-warning fw-semibold ms-auto" type="button"
                                    data-bss-hover-animate="tada">Tambah Berita
                                    <?xml version="1.0" ?>
                                        ...
                                        <tbody>
                                            @foreach ($newses as $key => $news)
                                                <tr>
                                                    ...
                                                    <td>{{ $news->kategori }}</td>
                                                    <td> <img src="{{ asset('images/' . $news->thumbnail) }}"
                                                            style="max-width:
                                                            150px; height:auto;">
                                                    </td>
                                                    <td>{{ $news->judul }}</td>
                                                    <td>{{ $news->creator }}</td>
                                                    <td>{!! \Illuminate\Support\Str::limit($news->berita, 150, $end = '...') !!}</td>
                                                    <td>
