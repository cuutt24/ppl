        ...
        <div class="m-md-5 m-sm-4 px-md-2 px-sm-0">
            ...
            <div class="row">
                <div class="col-md-12 col-sm-12">
                    <h2 style="color:rgb(7, 102, 173);"><b>Produk Hukum</b></h2>
                    ...
                    <table class="table table-hover table-responsive">
                        ...
                        <tbody>
                            <tr>
                                <th scope="row">1</th>
                                <td><b>Perdes Laporan Pertanggungjawaban APBDes Tahun Anggaran XX</td>
                                <td><b>Peraturan Desa</td>
                                <td>Laporan Pertanggungjawaban APBDes XX</td>
