...
@section('container')
    ...
    <div class="py-1 py-xl-1 px-md-5 px-sm-0 mx-5">
        <div class="m-md-5 m-sm-4 px-md-2 px-sm-0">
            ...
            <h2 style="color:#064708;"><b>Sejarah Desa Sumber Rejo</b></h2>
            <hr style="border: 1px solid green;
                    border-radius: 5px;">
            {{-- <p>Sejarah desa adalah catatan atau cerita tentang perkembangan, peristiwa, dan transformasi suatu wilayah atau
                pemukiman kecil dari masa lampau hingga saat ini. Sejarah desa mencakup berbagai aspek kehidupan masyarakat
                di dalamnya, seperti perubahan sosial, ekonomi, budaya, politik, dan lingkungan.
            </p> --}}
