...
@section('container')
    ...
    <div class="py-1 py-xl-1 px-md-5 px-sm-0 mx-5">
        <div class="m-md-5 m-sm-4 px-md-2 px-sm-0">
            ...
            <div class="card">
                <div class="card-body">
                    <p><b>Desa Sumber Rejo, Kecamatan Hulu Palik, Kabupaten Bengkulu Utara, Provinsi Bengkulu</b></p>
                    <table class="table">
                        <tbody>
                            <tr>
                                <td>Alamat</td>
                            ...
                            <tr>
                                <td>Nomor Telepon</td>
                                <td>0822-7876-5076</td>
                            </tr>
                            <tr>
                                <td>E-Mail</td>
                                <td>sumberrejo@gmail.com</td>
                            </tr>
                            <tr>
                                <td>Website</td>
                                <td>sumberrejo.com</td>
                            </tr>
                        </tbody>
                    </table>
                </div>
