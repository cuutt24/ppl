            ...
            <div class="card text-bg-light mb-3">
                <div class="card-body">
                    <a href="/">
                        ...
                        </svg></a> / Pembangunan Desa
                </div>
            </div>
            <div class="row">
                <div class="col-md-12 col-sm-12">
                    <h2 style="color:#064708;"><b>Pembangunan Desa</b></h2>
                    <hr style="border: 1px solid green;
                    border-radius: 5px;">
                    <h6 style="color:#064708;"><b>Pembangunan Desa (Perubahan: <span style="color: red;">Belum Dimulai</span>)</b></h6 >
